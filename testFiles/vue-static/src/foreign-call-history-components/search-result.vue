            ...
            <table class="table grid table-striped">
                ...
                <tr>
                    <td colspan="10" v-show="searchResult.length > 0">
                        <a href="javascript:void(0)" class="pull-left btn btn-xs btn-raised btn-primary" v-if="this.$store.state.options['/teleCommunicate/exportHistory/manage']" @click="exportHistory">{{this.$store.state.options['/teleCommunicate/exportHistory/manage']}}</a>
