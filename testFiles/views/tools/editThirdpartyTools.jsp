            ...
            <div class="kf5-section">
                <div class="field t-col" style="margin-bottom: 0;padding-bottom: 20px;">
                    <div>
                        ...
                        <input name="integrationName" id="integrationName" maxlength="255" type="text" value="${integration.integrationName}">
                    </div>
                </div>
            </div>
            ...
            <div class="kf5-section">
                <div class="field t-col" style="margin-bottom: 0;padding-bottom: 20px;">
                    <div>
                        ...
                        <input name="integrationUrl" id="integrationUrl" maxlength="255" type="text" value="${integration.integrationUrl}">
                    </div>
                </div>
            </div>
            <!--操作栏   -->
...
<script type="text/javascript">
    ...
    function addTemplate(){
        ...
        $.ajax({
            url: "<%=request.getContextPath()%>/integrations/editIntegration?integrationId=${integration.integrationId}",
            type:"post",
            dataType: 'json',
            ...
            success: function (data) {
                if (data.success) {
                    /* 返回字段管理界面 */
                    var title=linkName;
                    notice.success("第三方工具：" + title + "&nbsp;" + " 修改成功！");
