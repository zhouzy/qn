...
function PCAS() {
    if(arguments[0].charAt(0) === "#") {
        this.SelP = document.getElementById(arguments[0].substr(1));
    } else {
        this.SelP = document.getElementsByName(arguments[0])[0] || {};
    }
    if(arguments[1] != null && arguments[1].charAt(0) === "#") {
        this.SelC = document.getElementById(arguments[1].substr(1));
    } else {
        this.SelC = document.getElementsByName(arguments[1])[0] || {};
    }
    if(arguments[2] != null && arguments[2].charAt(0) === "#") {
        this.SelA = document.getElementById(arguments[2].substr(1));
    } else {
...
PCAS.SetP = function (PCA) {
    ...
    for (i = 0; i < PCAP.length; i++) {
        ...
        if (PCA.DefP == PCAPV)PCA.SelP[i + 1].selected = true
    }
    if (PCA.SelC)PCAS.SetC(PCA)
};
PCAS.SetC = function (PCA) {
    PI = PCA.SelP.selectedIndex - 1;
    PCA.SelC.length = 0;
